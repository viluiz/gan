...
# Regularization based on the discriminator    
def reg_disc(gen_output):
    return tf.math.log(1-tf.math.sigmoid(discriminator(gen_output, training=False)[0][0]))*weight_reg    
